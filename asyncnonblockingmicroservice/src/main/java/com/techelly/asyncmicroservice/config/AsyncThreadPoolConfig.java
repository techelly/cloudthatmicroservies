package com.techelly.asyncmicroservice.config;
...
public class AsyncThreadPoolConfig {
    ...
    @Value("${com.techelly.async.microservice.corepoolsize:1000}")
    private int corePoolSize;

    @Value("${com.techelly.async.microservice.maxpoolsize:1000}")
